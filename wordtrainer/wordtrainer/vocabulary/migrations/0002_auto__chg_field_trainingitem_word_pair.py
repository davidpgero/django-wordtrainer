...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrainingItem.word_pair'
        db.alter_column('vocabulary_trainingitem', 'word_pair_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vocabulary.WordPair']))

    def backwards(self, orm):

        # Changing field 'TrainingItem.word_pair'
        db.alter_column('vocabulary_trainingitem', 'word_pair_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vocabulary.WordList']))
    ...
    models = {
        ...
        'vocabulary.trainingitem': {
            ...
            'word_pair': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vocabulary.WordPair']"})
        },
        'vocabulary.wordlist': {
